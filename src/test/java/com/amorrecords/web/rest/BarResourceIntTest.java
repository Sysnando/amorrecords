...
import com.amorrecords.repository.BarRepository;
...
public class BarResourceIntTest {
    ...
    public void createBar() throws Exception {
        ...
        assertThat(testBar.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
    }
    ...
    public void updateBar() throws Exception {
        ...
        Bar testBar = barList.get(barList.size() - 1);
        assertThat(testBar.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
    }
