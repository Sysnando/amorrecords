package com.amorrecords.integration.discogs.client;

import com.amorrecords.integration.discogs.util.HttpRequest;
...
public class DiscogsClient {
    ...
    private String consumerKey = "qBAGZnhSOmfvldzpjmvK";
    private String consumerSecret = "jccWUKiIfacoighATXAXloyqeIOAGZVG";
    private String userAgent = "sysfel";
